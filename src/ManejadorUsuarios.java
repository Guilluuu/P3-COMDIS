...
public class ManejadorUsuarios {
    ...
    public static HashMap<String, List<String>> loadFriendsFromFile(String archivo) {
...
public static void saveFriendsToFile(Map<String, List<String>> friends, String archivo) {
    ...
    synchronized (archivo) {
        try {
            ...
            for (Map.Entry<String, List<String>> entry : friends.entrySet()) {
                ...
                List<String> amigosList = entry.getValue();
